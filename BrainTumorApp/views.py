...
model_predict = inceptionresnetv2(num_classes=1000, pretrained='imagenet')
...
# model_predict = torch.load("brain_tumor_inceptionresnetv1_98_acc_2_8.pth", map_location=torch.device('cpu'))
